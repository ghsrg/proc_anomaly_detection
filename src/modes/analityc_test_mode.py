...
def run_analitics_test_mode(args):
    """
   ...
   # logger.info("🚀 Запущено аналітичний режим.")
    print("⚙️ Виконується аналітичний режим тестування ...")

    final_df = aggregate_prefix_statistics(TEST_PR_DIAGRAMS_PATH) #комбінована статистика
    final_df_file = join_path([TEST_PR_DIAGRAMS_PATH, f'final_df_statistics.xlsx'])
    ...
    final_df_ac_file = join_path([TEST_PR_DIAGRAMS_PATH, f'final_train_vs_val_accuracy_all.xlsx'])
    save_aggregated_statistics(combined_df, final_df_ac_file)

    cm_bpmn = load_and_aggregate_confusion_matrices(TEST_PR_DIAGRAMS_PATH, data_type_filter="bpmn", reduction="avg", normalize=False)
    cm_norm_bpmn = load_and_aggregate_confusion_matrices(TEST_PR_DIAGRAMS_PATH, data_type_filter="bpmn", reduction="avg", normalize=True)
    final_cm_bpmn_file = join_path([TEST_PR_DIAGRAMS_PATH, f'final_cm_bpmn.xlsx'])
    save_aggregated_statistics(cm_bpmn, final_cm_bpmn_file)
    cm_logs = load_and_aggregate_confusion_matrices(TEST_PR_DIAGRAMS_PATH, data_type_filter="logs", reduction="avg", normalize=False)
    cm_norm_logs = load_and_aggregate_confusion_matrices(TEST_PR_DIAGRAMS_PATH, data_type_filter="logs", reduction="avg", normalize=True)
    final_cm_logs_file = join_path([TEST_PR_DIAGRAMS_PATH, f'final_cm_log.xlsx'])
    save_aggregated_statistics(cm_logs, final_cm_logs_file)

    graf_cm_diff_file = join_path([TEST_PR_DIAGRAMS_PATH, f'graf_cm_diff.png'])
    ...
    graf_cm_norm_diff_file = join_path([TEST_PR_DIAGRAMS_PATH, f'graf_cm_norm_diff.png'])
    ...
    graf_cm_bpmn_file = join_path([TEST_PR_DIAGRAMS_PATH, f'graf_cm_bpmn.png'])
    ...
    graf_cm_bpmn_file = join_path([TEST_PR_DIAGRAMS_PATH, f'graf_cm_norm_bpmn.png'])
    visualize_aggregated_conf_matrix(
        cm_df=cm_norm_bpmn,
    ...
    graf_cm_logs_file = join_path([TEST_PR_DIAGRAMS_PATH, f'graf_cm_logs.png'])
    visualize_aggregated_conf_matrix(
        cm_df=cm_logs,
    ...
    graf_cm_logs_file = join_path([TEST_PR_DIAGRAMS_PATH, f'graf_cm_norm_logs.png'])
    visualize_aggregated_conf_matrix(
        cm_df=cm_norm_logs,
    ...
    graf_regression_file = join_path([TEST_PR_DIAGRAMS_PATH, f'graf_regression_bpmn.png'])
    ...
    graf_regression_file = join_path([TEST_PR_DIAGRAMS_PATH, f'graf_regression_logs.png'])
    plot_regression_by_architecture(
        df=combined_df,
    ...
    graf_regression_file = join_path([TEST_PR_DIAGRAMS_PATH, f'graf_regression_grouped.png'])
    ...
    final_acc_df = aggregate_metric_over_epochs(TEST_PR_DIAGRAMS_PATH, 'val_accuracy')
    final_acct3_df = aggregate_metric_over_epochs(TEST_PR_DIAGRAMS_PATH, 'val_top_k_accuracy')
    final_train_loss_df = aggregate_metric_over_epochs(TEST_PR_DIAGRAMS_PATH, 'train_loss')
    final_oos_df = aggregate_metric_over_epochs(TEST_PR_DIAGRAMS_PATH, 'val_out_of_scope_rate')

    graf_radar_file = join_path([TEST_PR_DIAGRAMS_PATH, f'graf_radar_bpmn.png'])
    ...
    graf_radar_file = join_path([TEST_PR_DIAGRAMS_PATH, f'graf_radar_log.png'])
    plot_architecture_radar_by_metric(
        df=final_df,
    ...
    avg_epoch_time_bar_file = join_path([TEST_PR_DIAGRAMS_PATH, f'graf_bar_avg_epoch_time_bpmn.png'])
    ...
    avg_epoch_time_bar_file = join_path([TEST_PR_DIAGRAMS_PATH, f'graf_bar_avg_epoch_time_log.png'])
    plot_avg_epoch_time_bar(
        df=final_df,
    ...
    bar_radar_file = join_path([TEST_PR_DIAGRAMS_PATH, f'graf_bar_class_bpmn.png'])
    class_dict_dynamics = {
    ...
    bar_radar_file = join_path([TEST_PR_DIAGRAMS_PATH, f'graf_bar_atten_bpmn.png'])
    ...
    bar_radar_file = join_path([TEST_PR_DIAGRAMS_PATH, f'graf_bar_aggreg_bpmn.png'])
    ...
    bar_scope_file = join_path([TEST_PR_DIAGRAMS_PATH, f'graf_bar_scope_bpmn.png'])
    class_dict_scope = {
    ...
    bar_scope_file = join_path([TEST_PR_DIAGRAMS_PATH, f'graf_bar_input_bpmn.png'])
    class_dict_input = {
    ...
    bar_scope_file = join_path([TEST_PR_DIAGRAMS_PATH, f'graf_bar_model_type_bpmn.png'])
    ...
    #final_metric_file = join_path([TEST_PR_DIAGRAMS_PATH, f'final_df_val_accuracy.xlsx'])
    #save_aggregated_statistics(final_acc_df, final_metric_file)

    graf_acc_file = join_path([TEST_PR_DIAGRAMS_PATH, f'graf_accuracy_file.png'])
    ...
    graf_acct3_file = join_path([TEST_PR_DIAGRAMS_PATH, f'graf_acct3_file.png'])
    ...
    graf_loss_file = join_path([TEST_PR_DIAGRAMS_PATH, f'graf_loss_file.png'])
    ...
    graf_oos_file = join_path([TEST_PR_DIAGRAMS_PATH, f'graf_oos_file.png'])
    ...
    graf_acc_file = join_path([TEST_PR_DIAGRAMS_PATH, f'graf_accuracy_log_file.png'])
    ...
    graf_acct3_file = join_path([TEST_PR_DIAGRAMS_PATH, f'graf_acct3_log_file.png'])
    ...
    graf_loss_file = join_path([TEST_PR_DIAGRAMS_PATH, f'graf_loss_log_file.png'])
    ...
    graf_oos_file = join_path([TEST_PR_DIAGRAMS_PATH, f'graf_oos_log_file.png'])
